...
- [~] **Legal — real ToS/Privacy/Cookies on volt-www.** Replaced the thin placeholders with substantive content
      adapted from the PLC Assist production legal docs, reconciled to Volt's actual architecture: NL governing law,
      enumerated industrial-safety disclaimers (IEC 61131-3/62443, ISO 13849), an indemnification clause, and a new
      **Cookie Policy** page (terms + privacy + cookies, all footer-linked). Deliberately did NOT port PLC Assist's
      stored-conversation-history / AI-improvement-consent / Better Auth / Resend claims — Volt doesn't do those.
      Pages keep a "Pending review" banner. **Remaining:** final counsel sign-off before GA (esp. governing-law/venue
      and the data-practice claims). The console shows no legal footer, so nothing to wire back — purely volt-www.
