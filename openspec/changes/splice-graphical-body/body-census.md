...
| 8 | **CODESYS's merge REMOVES children absent from the document** (`ConflictResolve.Replace`, no delete) | `src/Volt.Cli.Ide.Codesys/Driver/CodesysDriver.Code.cs:35-48` | argues FOR splicing: a document left otherwise untouched is correct by construction |
