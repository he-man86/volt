...
NETWORK 0 LD "DONE Network 1: Activating/deactivating MID-S/Trayfiller"
  LET g0 := TRUE;
...
END_NETWORK
NETWORK 1 LD "DONE Network 2: Main Block FB100 TODO"
...
END_NETWORK
NETWORK 3 LD "DONE Network 3 :Muting zones"
...
END_NETWORK
NETWORK 4 LD "DONE NETWORK 4 (p1)Major alarms (start-up conditions)"
...
END_NETWORK
NETWORK 5 LD "DONE NETWORK 4 (p2)Major alarms (start-up conditions)"
...
END_NETWORK
NETWORK 6 LD "DONE NETWORK 4 (p3)Major alarms (start-up conditions)"
...
END_NETWORK
NETWORK 7 LD "DONE NETWORK 4 (p4)Major alarms (start-up conditions)"
...
END_NETWORK
NETWORK 9 LD "DONE NETWORK 4 (p3)Major alarms (start-up conditions)"
...
END_NETWORK
NETWORK 13 LD "TODO NETWORK 6"
  HMI_Var.Mach1.HourCounterRunning := (MainDrive(TRUE) AND Mach1.GenFlags.DriveIsRunning) SET;
END_NETWORK
NETWORK 14 LD "DONE NETWORK 6: Drives"
  Mach1_Drives_DB(EN := );
END_NETWORK
NETWORK 15 LD "DONE NETWORK 7: Positioned stop leaf carrier"
  LET g3 := TRUE;
...
END_NETWORK
NETWORK 16 LD "DONE NETWORK 8: Alarm Positioned stop leaf carrier"
...
END_NETWORK
NETWORK 17 LD "DONE NETWORK 9: Positioned stop cleaning"
  LET g4 := TRUE;
...
END_NETWORK
NETWORK 18 LD "DONE NETWORK 10: Alarm Positioned stop cleaning"
...
END_NETWORK
NETWORK 19 LD "DONE NETWORK 11 (p1): Level bunch magazine alarms"
...
END_NETWORK
NETWORK 20 LD "DONE NETWORK 11 (p2): Level bunch magazine alarms"
...
END_NETWORK
NETWORK 21 LD "TODO NETWORK 12: SR Bunches (JL / rolling device / outfeed)"
  ...
  tBool := g119;
END_NETWORK
NETWORK 22 LD "DONE NETWORK 13: Stop bunch infeed when cleaning is activated"
  HMI_Var.Btn_BunchSupply := Mach1_AuxData.Edge.OSP_Emptying_Cleaning(CLK := HMI_Var.Btn_Cleaning) SET;
END_NETWORK
NETWORK 23 LD "DONE NETWORK 14: PNV Block bunch infeed"
  LET g5 := TRUE;
  LET g6 := (g5 AND TRUE);
...
END_NETWORK
NETWORK 24 LD "DONE NETWORK 15: Muting of alarm ""No bunch"""
...
END_NETWORK
NETWORK 25 LD "DONE NETWORK 16 (p1): Alarms Bunch"
...
END_NETWORK
NETWORK 26 LD "DONE NETWORK 16 (p2): Alarms Bunch"
...
END_NETWORK
NETWORK 30 LD "DONE NETWORK 17 (p2): Alarms: Cigar fault"
...
END_NETWORK
NETWORK 31 LD "DONE NETWORK 17 (p3): Alarms: Cigar fault"
  ATD_SR(NOT LST_InputsOutputs.I101_2_Cigar_present, tbool, Mach1_AuxData.PhotocellCigarHasBeenOff);
END_NETWORK
NETWORK 32 LD "DONE NETWORK 18: Production counter"
...
END_NETWORK
NETWORK 33 LD "DONE NETWORK 19 (p1): Set cigar present in checkRegister"
  LET g124 := TRUE;
...
END_NETWORK
NETWORK 34 LD "DONE NETWORK 20: Start Fan"
...
END_NETWORK
NETWORK 36 LD "DONE NETWORK 21: Blocking glue rod"
...
END_NETWORK
NETWORK 37 LD "DONE NETWORK 22 (p1): Insert needle"
...
END_NETWORK
NETWORK 38 LD "DONE NETWORK 22 (p2): Insert needle"
...
END_NETWORK
NETWORK 39 LD "DONE NETWORK 23 (p1): Bunch positioner"
...
END_NETWORK
NETWORK 40 LD "DONE NETWORK 23 (p2): Bunch positioner"
...
END_NETWORK
NETWORK 41 LD "DONE NETWORK 24: Manual glue pumping"
...
END_NETWORK
NETWORK 42 LD "DONE NETWORK 25: Continuous Glueing"
  LET g15 := TRUE;
...
END_NETWORK
NETWORK 43 LD "DONE NETWORK 26: PNV Glue pump 1+2+3"
...
END_NETWORK
NETWORK 44 LD "DONE NETWORK 27: PNV Glue pump 4"
...
END_NETWORK
NETWORK 45 LD "DONE NETWORK 28: PNV Glue pump 5"
...
END_NETWORK
NETWORK 46 LD "DONE NETWORK 29: PNV Small gripper"
...
END_NETWORK
NETWORK 47 LD "DONE NETWORK 30: Big gripper"
...
END_NETWORK
NETWORK 48 LD "TODO NETWORK 31: Blow off wrapper"
...
END_NETWORK
NETWORK 49 LD "DONE NETWORK 32: Blow off bobbin"
...
END_NETWORK
NETWORK 50 LD "DONE NETWORK 33:"
  AHWF();
END_NETWORK
NETWORK 51 LD "TODO NETWORK 34: OBSOLETE"
END_NETWORK
NETWORK 52 LD "DONE NETWORK 35: Main FB:  Dryer-trayfiller"
...
END_NETWORK
NETWORK 53 LD "DONE NETWORK 36: CT Fan dryer"
...
END_NETWORK
NETWORK 55 LD "DONE NETWORK 38 (p1): Alarms dryer"
...
END_NETWORK
NETWORK 56 LD "DONE NETWORK 38 (p2): Alarms dryer"
...
END_NETWORK
NETWORK 57 LD "TODO NETWORK 38 (p3): Alarms dryer"
...
END_NETWORK
NETWORK 58 LD "DONE NETWORK 38 (p4): Alarms dryer"
...
END_NETWORK
NETWORK 59 LD "TODO NETWORK 39: Analog setpoint feedforward dryer"
  SpeedCalculationDryer();
END_NETWORK
NETWORK 60 LD "TODO NETWORK 40: Analog setpoint feedforward trayfiller"
  SpeedCalculationTrayfiller();
END_NETWORK
NETWORK 61 LD "DONE NETWORK 41: Empty trayfiller"
...
END_NETWORK
NETWORK 62 LD "DONE NETWORK 42: Main block Trayfiller"
...
END_NETWORK
NETWORK 64 LD "DONE NETWORK 43: Selection of inpusher runtimeguard time"
  LET g20 := IDB_TrayFiller.oValveInpusher;
  MOVE(g20, T#1S);
  MOVE(NOT(g20), T#5S);
END_NETWORK
NETWORK 65 LD "DONE NETWORK 44 (p1): Runtimeguard trayfiller"
...
END_NETWORK
NETWORK 66 LD "DONE NETWORK 44 (p2): Runtimeguard trayfiller"
...
END_NETWORK
NETWORK 67 LD "DONE NETWORK 44 (p3): Runtimeguard trayfiller"
...
END_NETWORK
NETWORK 68 LD "DONE NETWORK 44 (p4): Runtimeguard trayfiller"
...
END_NETWORK
NETWORK 69 LD "DONE NETWORK 45: Elevator: profinet vs IO"
...
END_NETWORK
NETWORK 70 LD "DONE NETWORK 46 (p1): Alarms trayfiller"
...
END_NETWORK
NETWORK 71 LD "DONE NETWORK 46 (p2): Alarms trayfiller"
...
END_NETWORK
NETWORK 72 LD "DONE NETWORK 46 (p3): Alarms trayfiller"
...
END_NETWORK
NETWORK 73 LD "DONE NETWORK 46 (p4): Alarms trayfiller"
...
END_NETWORK
NETWORK 74 LD "DONE NETWORK 46 (p5): Alarms trayfiller"
...
END_NETWORK
NETWORK 75 LD "DONE NETWORK 46 (p6): Alarms trayfiller"
...
END_NETWORK
NETWORK 76 LD "DONE NETWORK 46 (p7): Alarms trayfiller"
...
END_NETWORK
NETWORK 77 LD "DONE NETWORK 46 (p8): Alarms trayfiller"
...
END_NETWORK
NETWORK 78 LD "DONE NETWORK 46 (p9): Alarms trayfiller"
...
END_NETWORK
NETWORK 79 LD "TODO NETWORK 47 (p1):Greasing system"
END_NETWORK
NETWORK 80 LD "DONE NETWORK 47 (p2): Greasing system"
...
END_NETWORK
NETWORK 81 LD "DONE NETWORK 48: Alarm: Greasing system"
...
END_NETWORK
NETWORK 82 LD "DONE NETWORK 49: State of the machine"
  LET g22 := TRUE;
...
END_NETWORK
NETWORK 83 LD "TODO NETWORK 50: SL Alarmlamp"
  LET g25 := TRUE;
...
END_NETWORK
NETWORK 84 LD "TODO NETWORK 51: SL Alarmlamp Buzzer"
END_NETWORK
