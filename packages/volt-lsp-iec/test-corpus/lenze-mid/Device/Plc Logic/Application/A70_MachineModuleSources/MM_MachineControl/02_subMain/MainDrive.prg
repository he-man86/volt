...
NETWORK 1 LD TITLE: "DONE NETWORK 2: Activating main drive"
  ...
  MOVE(((g176 AND (NOT Mach1_AuxData.MemLowerSpeedBecauseOfNoWrapper OR (Mach1_AuxData.MemLowerSpeedBecauseOfNoWrapper <= Mach1_Data.AUTOSPEED <= 40))) AND NOT HMI_Var.Btn_Cleaning), Mach1_Data.AUTOSPEED);
  MOVE((((g176 AND Mach1_AuxData.MemLowerSpeedBecauseOfNoWrapper) > Mach1_Data.AUTOSPEED > 40) AND NOT HMI_Var.Btn_Cleaning), 30);
  MOVE((g176 AND HMI_Var.Btn_Cleaning), 6);
