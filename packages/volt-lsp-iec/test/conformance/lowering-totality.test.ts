 ...
 * zero-size element, and a date literal outside JS `Date`'s range — and they are pinned beside the code that
 * answers them (`src/transpile/lower/totality.test.ts`). A corpus pass is evidence, not proof.
 *
