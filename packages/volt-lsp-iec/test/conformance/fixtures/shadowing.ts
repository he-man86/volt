...
export const SHADOWING_TESTS: readonly LanguageTest[] = [
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_shadowing_method_local_shadows_member
VAR
	iCounter : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_shadowing_method_param_shadows_member
VAR
	iValue : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_method_local_shadows
VAR
	iCount : INT;
END_VAR
