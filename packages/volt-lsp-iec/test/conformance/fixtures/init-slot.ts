...
export const INIT_SLOT_TESTS: readonly LanguageTest[] = [
...

  {
    ...
    plcPrgBody: "fb_d50();",
    source: `{attribute 'global_init_slot' := '50000'}
...
`,
...

  {
    ...
    plcPrgBody: "fb_iram();",
    source: `{attribute 'global_init_slot' := '30000'}
...
`,
...

  {
    ...
    plcPrgBody: "fb_ird();",
    source: `{attribute 'global_init_slot' := '60000'}
...
`,
...

  {
    ...
    plcPrgBody: "fb_iue();",
    source: `{attribute 'global_init_slot' := '48000'}
