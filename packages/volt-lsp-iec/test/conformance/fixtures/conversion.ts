...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conversion_int_to_real_wrong_source
VAR
	rSrc : REAL;
	rDst : REAL;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conversion_dint_to_int_wrong_source
VAR
	iSrc : INT;
	iDst : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conversion_implicit_dint_to_int
VAR
	diSrc : DINT;
	iDst : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conversion_overloaded_to_int
VAR
	diSrc : DINT := 1000;
	iDst : INT;
END_VAR
...
`,
  ...
  // ─── Narrowing — implicit LREAL→REAL (oracle: does the compiler WARN?) ───
  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_narrowing_lreal_to_real
VAR
	rDst : REAL;
