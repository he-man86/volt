...
export const OVERFLOW_TESTS: readonly LanguageTest[] = [
	// ─── Signed integer overflow ─────────────────────────────────────────
	{
		...
		plcPrgBody: "fb_iam();",
		source:
`FUNCTION_BLOCK FB_LANG_overflow_int_at_max
VAR
	value : INT := 32767;
END_VAR
...
`,
	},
	{
		...
		plcPrgBody: "fb_iabv();",
		source:
`FUNCTION_BLOCK FB_LANG_overflow_int_above_max
VAR
	value : INT := 40000;
END_VAR
...
`,
	},
	{
		...
		plcPrgBody: "fb_ssm();",
		source:
`FUNCTION_BLOCK FB_LANG_overflow_sint_above_max
VAR
	value : SINT := 200;
END_VAR
...
`,
	...
	// ─── Unsigned integer range ──────────────────────────────────────────
	{
		...
		plcPrgBody: "fb_bam();",
		source:
`FUNCTION_BLOCK FB_LANG_overflow_byte_above_max
VAR
	value : BYTE := 300;
END_VAR
...
`,
	},
	{
		...
		plcPrgBody: "fb_wam();",
		source:
`FUNCTION_BLOCK FB_LANG_overflow_word_above_max
VAR
	value : WORD := 70000;
END_VAR
...
`,
	},
	{
		...
		plcPrgBody: "fb_un();",
		source:
`FUNCTION_BLOCK FB_LANG_overflow_uint_negative
VAR
	value : UINT := -5;
END_VAR
...
`,
	...
	// ─── Typed literal overflow ──────────────────────────────────────────
	{
		...
		source:
`FUNCTION_BLOCK FB_LANG_overflow_typed_literal_int
VAR
	value : INT;
END_VAR
