 ...
 */
function enumStorage(lw: Lowering, t: Extract<Type, { kind: "enum" }>): Type {
 ...
 */
function enumConstant(lw: Lowering, e: Expr): IrExpr | undefined {
...
function rootType(lw: Lowering, place: Place): Type | undefined {
  switch (place.root) {
    case "local":
 ...
 */
function byteSize(lw: Lowering, t: Type): { size: bigint; align: bigint } | undefined {
 ...
 */
function fieldBytes(lw: Lowering, t: Extract<Type, { kind: "struct" | "function_block" }>): { size: bigint; align: bigint; offsets?: Map<string, bigint> } | undefined {
...
function byteOffset(lw: Lowering, place: Place): bigint | undefined {
 ...
 */
function sizeOf(lw: Lowering, e: Extract<Expr, { kind: "call" }>): IrExpr | undefined {
 ...
 */
function adrDifference(lw: Lowering, e: Extract<Expr, { kind: "binary" }>): IrExpr | null | undefined {
...
function pointerKey(lw: Lowering, p: Place): string | undefined {
...
function recordTarget(lw: Lowering, key: string, target: PointerTarget, span: Span): boolean {
...
function addressOf(lw: Lowering, x: Expr, pointerType: Type, span: Span): { value: IrExpr; target: PointerTarget } | undefined {
...
function pointerValue(lw: Lowering, e: Expr, pointerType: Type): { value: IrExpr; target?: PointerTarget } | undefined {
...
function pointeePlace(lw: Lowering, pointer: Place, extra: IrExpr | undefined, span: Span): Place | undefined {
...
function storePointer(lw: Lowering, target: Place, value: Expr, span: Span): IrStmt | undefined {
...
function bindReference(lw: Lowering, s: Extract<Statement, { kind: "assign" }>): IrStmt | undefined {
 ...
 */
function through(lw: Lowering, place: Place, span: Span): Place | undefined {
...
function loadValue(lw: Lowering, place: Place, span: Span): IrExpr | undefined {
 ...
 */
function globalPlace(lw: Lowering, name: string, span: Span): Place | undefined {
  const upper = name.toUpperCase()
 ...
 */
function calledRoutine(lw: Lowering, sym: NonNullable<ReturnType<typeof lookup>>["symbol"], fb: IrLayout | undefined, span: Span): IrRoutine | undefined {
 ...
 */
function lowerInvoke(lw: Lowering, call: Extract<Expr, { kind: "call" }>): IrInvoke | undefined {
...
function declareInOuts(lw: Lowering, sections: readonly VarSection[]): void {
 ...
 */
function calledLayout(lw: Lowering, name: string, span: Span): IrLayout | undefined {
  const key = name.toUpperCase()
 ...
 */
function inGlobals(lw: Lowering, place: Place): boolean {
 ...
 */
function lowerCallStatement(lw: Lowering, call: Extract<Statement, { kind: "call_stmt" }>["call"]): IrStmt[] | undefined {
  const callee = call.callee
 ...
 */
function storageOf(lw: Lowering, t: Type): Type {
...
function buildLayout(lw: Lowering, t: Extract<Type, { kind: "struct" | "function_block" }>, sym: ReturnType<typeof lookup> extends infer R ? (R extends { symbol: infer S } ? S : never) | undefined : never): void {
...
function declareVars(lw: Lowering, sections: readonly VarSection[]): void {
...
function aliasInit(lw: Lowering, t: TypeExpr): Initializer | undefined {
...
function stringLiteralText(lw: Lowering, e: Extract<Expr, { kind: "literal" }>): string | null {
...
function foldConstant(lw: Lowering, e: Expr): IrValue | undefined {
...
function lowerPlace(lw: Lowering, e: Expr, notAMember = "place-shape"): Place | undefined {
  if (e.kind === "member") {
 ...
 */
function bitPlace(lw: Lowering, e: Extract<Expr, { kind: "member" }>, notABit: string): Place | undefined {
 ...
 */
function lowerExpr(lw: Lowering, e: Expr, expected?: Type): IrExpr | undefined {
  switch (e.kind) {
    case "literal": {
      const v = e.value
 ...
 */
function lowerBuiltin(lw: Lowering, e: Extract<Expr, { kind: "call" }>): IrExpr | undefined {
 ...
 */
function lowerStandardString(lw: Lowering, e: Extract<Expr, { kind: "call" }>, name: string): IrExpr | undefined {
 ...
 */
function lowerConversion(lw: Lowering, e: Extract<Expr, { kind: "call" }>, from: Type | undefined, to: Type): IrExpr | undefined {
...
function meetOperands(lw: Lowering, operands: readonly IrExpr[], span: Span): Type | undefined {
...
function lowerBlock(lw: Lowering, list: StatementList): IrStmt[] {
  const out: IrStmt[] = []
  for (const s of list) {
 ...
 */
function lowerChain(lw: Lowering, s: Extract<Statement, { kind: "assign" }>): IrStmt[] | undefined {
...
function lowerStmt(lw: Lowering, s: Statement): IrStmt | IrStmt[] | undefined {
  switch (s.kind) {
    case "empty":
      return undefined
    case "assign": {
 ...
 */
function lowerFor(lw: Lowering, s: Extract<Statement, { kind: "for" }>): IrStmt | undefined {
...
function sameStorage(a: Type, b: Type): boolean {
