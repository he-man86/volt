...
DLL resolution (first that exists wins):
  ...
  2. <this folder>/VoltBridge.Codesys.dll     production (installer ships
...
_DLL_NAME = "VoltBridge.Codesys.dll"
...
_REPO_BIN = r"C:\Users\marce\OneDrive\Documenten\Github\volt\packages\volt-bridges\src\VoltBridge.Codesys\bin"
...
try:
    ...
    if not dll:
        ...
        from VoltBridge.Codesys import Host
