...
public class VgRoundTripTests
{
    ...
    // exact string is brittle. Inputs here are written in the older verbose form on purpose — they must still
    // parse and settle. (The exact canonical text is pinned separately in VgWriterTests.)
