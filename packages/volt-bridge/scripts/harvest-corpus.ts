 ...
 *
 *   bun packages/volt-bridge/scripts/harvest-corpus.ts [port]      # default 8556 (CODESYS); 8555 = TwinCAT
 *
...
const corpus = join(
	import.meta.dirname, "..", // this script lives in packages/volt-bridge/scripts
	"test", "Volt.Bridge.Tests", "fixtures", "corpus",
)
