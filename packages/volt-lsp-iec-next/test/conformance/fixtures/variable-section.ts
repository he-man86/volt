...
export const VARIABLE_SECTION_TESTS: readonly LanguageTest[] = [
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_io_kinds
VAR_INPUT
	iIn : INT;
END_VAR
VAR_OUTPUT
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_input_constant
VAR_INPUT CONSTANT
	iLimit : INT;
END_VAR
VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_inst_method
VAR
	iLast : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_stat_method
VAR
	iSeen : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_retain
VAR RETAIN
	iCount : DINT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_persistent
VAR PERSISTENT
	iCount : DINT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_non_retain
VAR NON_RETAIN
	iCount : DINT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_var_external_consumer
VAR_EXTERNAL
	gShared : INT;
END_VAR
VAR
...
`,
...

  {
    ...
    source: `FUNCTION FB_LANG_function_var_output : INT
VAR_INPUT
	iA : INT;
	iB : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_inline_enum_var
VAR
