...
export const CONDITIONAL_PRAGMA_TESTS: readonly LanguageTest[] = [
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conditional_define_then_if
VAR
	iCounter : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conditional_else_branch_taken
VAR
	iCounter : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conditional_elsif_chain
VAR
	iCounter : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conditional_orphan_else
VAR
	iCounter : INT;
END_VAR
...
`,
...

  {
    ...
    source: `FUNCTION_BLOCK FB_LANG_conditional_undefine_after_define
VAR
	iCounter : INT;
END_VAR
