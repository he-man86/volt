/**
 * Real-project corpus gate for the syntax layer (A.3). References the legacy package's
 * committed 4-project corpus (never copies it — task 0.0). Two hard gates:
...
const CORPUS_ROOT = join(import.meta.dir, "..", "..", "..", "volt-lsp-iec", "test-corpus")
