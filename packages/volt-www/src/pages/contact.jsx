...
renderPage(
  <>
    <PageHeader eyebrow="Contact" title="Talk to us." lead="Questions about Volt or a specific PLC setup? We'd like to hear from you." />
    <section className="section container" style={{ maxWidth: 560 }}>
      <Reveal>
        <div className="card" style={{ display: "grid", gap: "var(--space-4)", textAlign: "center", padding: "var(--space-8)" }}>
