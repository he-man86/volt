...
// Canonical brand copy, kept as the single source of truth even when no page currently reads it
export const BRAND = {
  name: "Volt",
...
// Home feature grid + the per-feature detail pages share this list (slug === the /features/<slug> route).
export const FEATURES = [
  {
    ...
    blurb:
      "Pull your live CODESYS or TwinCAT project into git as clean text. Branch, diff, review, and merge with the tools you already know — then push back to the IDE.",
    points: [
  ...
  },
  {
    ...
    blurb:
      "A TypeScript-native language server for IEC 61131-3: go-to-definition, diagnostics, hover, completion, and signature help across your whole project — powered by an embedded CODESYS reference.",
    points: [
  ...
  },
  {
    ...
    blurb:
      "Structured Text and editable graphical logic (FBD/LD) become first-class text the agent can read, explain, and edit — not opaque blobs it has to guess at.",
    points: [
  ...
  },
  {
    ...
    blurb:
      "Volt maps your program organization units, function blocks, libraries, and device instances — so the agent answers with your architecture in mind, not a generic guess.",
    points: [
  ...
  },
  {
    ...
    blurb:
      "A native desktop shell for day-to-day engineering, and a scriptable `volt` CLI for the terminal and CI. Same core, your choice of surface.",
    points: [
  ...
  },
  {
    ...
    blurb:
      "Your PLC code is your IP. Volt runs locally and brings your own AI provider key — nothing about your project is uploaded to make the tooling work.",
    points: [
...
// Nav: Product is a dropdown of the two guide pages; Resources groups the support pages. An entry with
// `href` (no `items`) renders as a plain link; `items` renders a dropdown.
export const NAV = [
  {
    label: "Product",
    items: [
      { label: "Getting started", href: "/docs" },
      { label: "Desktop or VS Code?", href: "/docs/desktop-vs-vscode" },
    ],
  },
...
export const PRICING = [
  ...
  },
  {
    ...
    features: ["Everything in Free", "Unlimited bound projects", "Priority language-server updates", "Email support"],
    cta: "Buy Volt Pro",
    kind: "buy",
    featured: true,
  },
...
export const FAQ = [
  {
    q: "Which PLCs does Volt support?",
    a: "CODESYS and TwinCAT/Beckhoff today. Both serve the same wire, so the experience is identical across vendors.",
  },
  {
    q: "Does my code leave my machine?",
    a: "No. The language server analyzes your project locally, and you bring your own AI provider key — so prompts go to the provider you choose, not to us.",
  },
  {
    q: "Is this a fork of my IDE?",
    a: "No. Volt sits alongside your live CODESYS or TwinCAT IDE and syncs your project into git as text. The IDE stays the source of truth for build and codegen.",
  },
  {
    q: "What platforms does the installer run on?",
    a: "Windows — Volt's PLC tooling (the bridges, CODESYS integration) is Windows-native.",
  },
  {
...
export const CHANGELOG = [
  {
    ...
    date: "2026",
    items: [
      "Git-native pull/push for CODESYS and TwinCAT",
      "Structured Text language server (nav, diagnostics, hover)",
      "Desktop app and volt CLI",
    ],
  },
]
