...
export const meta = () => [
  { title: "Docs — Volt" },
  {
    name: "description",
    content:
      "Get started with Volt: install, connect the Connector to your live CODESYS or TwinCAT IDE, pull your project into git, work with the AI agent, and push back.",
  },
]
