...
This file focuses on Structured Text (ST) and Extended Structured Text (ExST), since volt-lsp-codesys targets ST. The other languages are catalogued for context.
