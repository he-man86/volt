...
/// port of packages/volt-git/src/bridge/client.ts. Two simplifications the unification enables: no zod schemas
...
public sealed class BridgeClient
{
    ...
    public static BridgeClient ForPort(int port) => new(PipeNames.ForPort(port));
