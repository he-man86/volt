...
/// item, and its folder path within the project. Exclude-from-build is NOT modeled: an excluded object
/// is synced as an ordinary file like any other — the bridge draws no distinction.</summary>
