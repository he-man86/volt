...
public class FetchExclusionTests
{
    ...
    public void Referenced_library_element_folds_beside_its_library()
    {
        ...
        var handle = new Volt.Cli.Core.Library.LibSignature("HANDLE", "caatypes", "Type",
            new Volt.Cli.Core.Library.LibVar[0], new Volt.Cli.Core.Library.LibVar[0],
            new Volt.Cli.Core.Library.LibVar[0], new Volt.Cli.Core.Library.LibVar[0], null, null, "__XWORD");
        var ide = new FakeIde(
    ...
    {
        var manifest = "LIBRARY CAA Types\nNAMESPACE CAA\nRESOLUTION caatypes\nPLACEHOLDER false\nSYSTEM false\n";
        var orphan = new Volt.Cli.Core.Library.LibSignature("SOMEFB", "cmpeventmgr implementation, 3.5 (system)", "FunctionBlock",
            new Volt.Cli.Core.Library.LibVar[0], new Volt.Cli.Core.Library.LibVar[0],
            new Volt.Cli.Core.Library.LibVar[0], new Volt.Cli.Core.Library.LibVar[0], null, null);
        var ide = new FakeIde(
            FakeIde.Item.TextualPou("User", "FUNCTION_BLOCK User\nEND_FUNCTION_BLOCK", ""),
            FakeIde.Item.Library("CAA Types", manifest, "Library Manager"))
